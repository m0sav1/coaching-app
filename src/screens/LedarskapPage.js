  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <Text style={{ fontSize: 20 }}>This is Motiverande Ledarskap Intro Page. Text in the middle, here wil come some info about the corse
      ...
      <View style={{ paddingBottom: 20 }}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Ledarskap")}
        >
